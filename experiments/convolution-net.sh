...
th utils/index-to-torch-tensors-converter.lua -inFile data/conll2003/eng.train.iobes.index  -outFile data/conll2003/eng.train.iobes.torch -mode sentence-convolution

# Run learning
th conll_learn.lua -version 1-convolution-sentence-net -mode sent -cuda -model_name convolution-full
